...
class PrimazaWorker(object):
    ...
    def __init__(self, cluster_name: str, kubeconfigfile: str, namespace: str = "primaza-system-worker"):
        print("Init called")
    ...
    def update_kube_config(self,kubeconfigfile: str):
        kube_config = KubeConfigContent(self.primaza_cluster_name,kubeconfigfile)
